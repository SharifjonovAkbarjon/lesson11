...
const Product = () => {
    ...
    const productItem = products?.map((product) => (
        <div key={product.id} className='product_cart hover:cursor-pointer  group relative overflow-hidden md:w-[48%] lg:w-[18%] mt-7 p-4 border-slate-300 flex flex-col items-center'>
